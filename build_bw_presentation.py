...
"""
=============================================================================
Black & White Minimalist Presentation Builder: EXAELIA 80m BWB (MMS236 DT1)
=============================================================================
...
Theme: High-Contrast Black & White Monochrome Studio
- Pure pitch black canvas (#000000)
- Crisp stark white typography (#FFFFFF) & zinc silver accents (#A1A1AA, #71717A)
- Subtle obsidian cards (#121214) with fine 1px zinc borders (#27272A)
- All visuals, sketches, and charts 100% monochrome & seamlessly blended
=============================================================================
"""
...
# -----------------------------------------------------------------------------
BG_COLOR     = RGBColor(0, 0, 0)          # #000000 Pure Pitch Black
CARD_BG      = RGBColor(18, 18, 20)       # #121214 Obsidian Surface
BORDER_COLOR = RGBColor(39, 39, 42)       # #27272A Subtle Zinc Border
TEXT_WHITE   = RGBColor(255, 255, 255)    # #FFFFFF Stark White
TEXT_LIGHT   = RGBColor(228, 228, 231)    # #E4E4E7 Zinc 200
TEXT_MUTED   = RGBColor(161, 161, 170)    # #A1A1AA Zinc 400
TEXT_SUBTLE  = RGBColor(113, 113, 122)    # #71717A Zinc 500
...
def build_bw_presentation(output_paths):
    prs = Presentation()
    prs.slide_width = Inches(13.333)
    prs.slide_height = Inches(7.500)
    blank_layout = prs.slide_layouts[6]

    bw_dir = "/Users/jakkasaisrinivasamanideep/Documents/MMS236/04_Presentation_Assets/bw"
    img_sketch  = os.path.join(bw_dir, "slide2_sketch_bw.png")
    img_mission = os.path.join(bw_dir, "slide3_mission_bw.png")
    img_sfc     = os.path.join(bw_dir, "slide4_sfc_bw.png")
    img_concept = os.path.join(bw_dir, "slide7_concept_bw.png")

    # =========================================================================
    # SLIDE 1: Title Slide (Pure B&W Minimalist)
    # =========================================================================
    ...
    # Key Specs Strip (Monochrome Bar)
    ...
    # =========================================================================
    # SLIDE 2: Blended wing body (Seamless Floating Linework)
    # =========================================================================
    ...
    if os.path.exists(img_sketch):
        slide2.shapes.add_picture(img_sketch, Inches(4.8), Inches(1.45), height=Inches(5.1))

    # Caption Tag
    tb_cap2 = slide2.shapes.add_textbox(Inches(0.9), Inches(6.8), Inches(11.533), Inches(0.35))
    ...
    # =========================================================================
    # SLIDE 3: Sizing mission (Pure B&W Flight Envelope)
    # =========================================================================
    ...
    if os.path.exists(img_mission):
        slide3.shapes.add_picture(img_mission, Inches(1.4), Inches(1.45), width=Inches(10.533))

    tb_cap3 = slide3.shapes.add_textbox(Inches(0.9), Inches(6.8), Inches(11.533), Inches(0.35))
    ...
    # =========================================================================
    # SLIDE 4: Engine performance (SFC Chart + User Bullets)
    # =========================================================================
    slide4 = prs.slides.add_slide(blank_layout)
    set_slide_background(slide4)
    add_header(slide4, "Engine performance", "Propulsion Modeling")

    # Left: Pure Monochrome SFC Chart
    if os.path.exists(img_sfc):
        slide4.shapes.add_picture(img_sfc, Inches(0.9), Inches(1.45), width=Inches(6.8))

    # Right: User's exact bullets as clean minimalist cards
    # Card 1: Trend line
    add_card(slide4, Inches(8.0), Inches(1.5), Inches(4.433), Inches(2.4))
    tb4_1 = slide4.shapes.add_textbox(Inches(8.3), Inches(1.75), Inches(3.8), Inches(1.9))
    ...
    add_card(slide4, Inches(8.0), Inches(4.15), Inches(4.433), Inches(2.4))
    tb4_2 = slide4.shapes.add_textbox(Inches(8.3), Inches(4.4), Inches(3.8), Inches(1.9))
    ...
    for idx, (lbl, val, note) in enumerate(aero_items):
        ...
        p_nt.font.color.rgb = TEXT_LIGHT
        p_nt.space_before = Pt(3)

    # Note at bottom for L/D Loiter = 24.5
    tb_loiter = slide5.shapes.add_textbox(Inches(0.9), Inches(6.8), Inches(11.533), Inches(0.35))
    ...
    for idx, (lbl, val, formula, note) in enumerate(mtow_cards):
        ...
        p_val.text = val
        p_val.font.name = FONT_HEADING
        p_val.font.size = Pt(28 if len(val) > 10 else 38)
        p_val.font.bold = True
        p_val.font.color.rgb = TEXT_WHITE
    ...
    tb_sub7 = slide7.shapes.add_textbox(Inches(0.9), Inches(1.35), Inches(11.5), Inches(0.35))
    ...
    # Seamless Floating Concept Sketch
    if os.path.exists(img_concept):
        slide7.shapes.add_picture(img_concept, Inches(2.9), Inches(1.7), height=Inches(4.8))

    tb_cap7 = slide7.shapes.add_textbox(Inches(0.9), Inches(6.8), Inches(11.533), Inches(0.35))
    ...
    # =========================================================================
    # SLIDE 8: References (Clean B&W Links)
    # =========================================================================
    ...
    for p in output_paths:
        ...
        prs.save(p)
        print(f"[OK] Saved B&W presentation: {os.path.abspath(p)}")
